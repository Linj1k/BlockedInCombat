...
public class ScoreboardSign {
	...
	/**
	 * Send the packets to remove this scoreboard sign. A destroyed scoreboard sign must be recreated using {@link fr.kinj14.blockedincombat.Library.ScoreboardSign#create()} in order
	 * to be used again
	 */
	public void destroy() {
		if (!created)
