...
public class ConfigManager {
    ...
    public Location getLocationConfig(String WorldName, String LocationName){
        return deserializeLocation(WorldName, Objects.requireNonNull(cfg.getString(LocationName)));
    }
    ...
    public boolean checkForUpdate(){
        ...
        lastCheckUpdate = new JSONObject(query);
    ...
    public boolean RetroCompatibility(){
        ...
        if(!oldCfg.contains("Version") || !Objects.equals(oldCfg.getString("Version"), main.version)){
            configFile.delete();
